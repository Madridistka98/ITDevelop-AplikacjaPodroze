...
class DestinationSeeder extends Seeder
{
    ...
    public function run()
    {
        $hotels_handle = fopen(__DIR__ . DIRECTORY_SEPARATOR ."worldcities.csv", "r");
        fgetcsv($hotels_handle, 1000);
        $count = 1;
        $FILE_LINES = 26570;
        while ($row = fgetcsv($hotels_handle, 1000)) {
            print("Line: $count of $FILE_LINES \n");
